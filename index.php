  ...
  <body>
    ...
    <header id="logo" class="text-center">
      ...
      <ul class="ul row" style="list-style-type: none;">
        ...
        <li class="limenu col-9 col-md-2"><a class="menu" href="login.php" id="link5" target="_blank">Cadastro</a></li>
      </ul>
    ...
    <footer class="text-center">
      <a href="#logo"> <img src="imagens/DronesDigital.png" class="logobaixo" alt="logosite" width=100px height=""> </a>
        <div class="contato">
          <p>Telefone para contato: 22122221 / 209309--030</p>
          <p>Email: dronedigital@hotmail.com</p>
          <p>Localização: AV libato 123</p>
        </div>
    </footer>
